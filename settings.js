...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "bNxXzJyI#LW2E18-0HrgJQTa5P2waT-bXdf7-cOUcuO7rAs4T0GI", // Add your session id
PREFIX: process.env.PREFIX || "JD",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94713222037",
DEV: process.env.DEV || "94717874659",
